...
/**
 * Task handler checking accessibility of autopilot unit. If it receives data
 * from autopilot unit it configures servos according to given values.
 * 
 * T = 50ms
 * 
...
public class CheckMega128ValuesTaskHandler implements Runnable {
  ...
  public void run() {
    ...
    // InterMCUMsg msg =
    // fbwModule.getLinkToAutopilot().getMessageFromAutopilot();
    // // message if message is fully received (SPI reception takes a time,
    // however we return message
    ...
    // Log.i("CheckMega128TaskHandler",
    // "FEWMODE is setted to auto, set servors radio commands");

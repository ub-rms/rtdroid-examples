 ...
 * 
 */
public class SimulatorServosControllerImpl extends ServosControllerImpl
    implements SimulatedDevice {
  ...
  public void setServos(RadioCommands radioCommands) {
    ...
    // LogUtils.log(this, "Radio commands for servos: " +
    // radioCommands.toString());

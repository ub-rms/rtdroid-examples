...
public interface IRConf {
  ...
  // public static final int DEFAULT_IR_ROLL_NEUTRAL = -915; // FIXME this value
  // is not handled correctly by simulator
  public static final int DEFAULT_IR_ROLL_NEUTRAL = 0;

  // public static final int DEFAULT_IR_PITCH_NEUTRAL = 110; // FIXME this value
  // is not handled correctly by simulator

 ...
 *
 * The concrete flight plan should be automatically generated from fligh-plan
 * description and should inherit from this class.
 *
...
public abstract class AbstractFlightPlan implements FlightPlan {
  ...
  public void setAutopilotStatus(AutopilotStatus status) {
    this.status = status;
  }
   ...
   *
   * User should use method {@link #addWaypoint(Position3D)} to fill an internal
   * array of waypoints.
   */
   ...
   *
   * User should use method {@link #addNavBlock(NavigationBlock)} to add
   * navigation blocks.
   */
   ...
   */
  protected int getStartNavBlockNumber() {
    return 0;
  }
  ...
  private void missionFinished() {
    System.out.println("Flightplan finished - mission termination requested");
...
//      System.out.println("Block " + blockNumber + " Stage "
//          + this.currentStage.stageNumber + " executed");
    ...
    /**
     * This method is call after execution stage code (stage can skip this
     * code).
     *
     * User can override this method.
     */
    ...
    /**
     * Called by flight plan to setup a navigation block number. Block number
     * depends on addition of navigation block into the flight plan.
     *
  ...
  public abstract class NavigationStage extends NavigatorCommands {
    ...
    @Override
    protected Position3D WP(int n) {
      return AbstractFlightPlan.this.WP(n);
    }

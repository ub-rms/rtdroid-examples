 ...
 * 
 * Note: - it would be nice to fill dependencies (Estimator, GPSDevice) like in
 * IoC containers with possibility to choose allocation area (mission/immortal)
 * 
 * @author Michal Malohlava
 * 
 */
public interface AutopilotModule extends Module, AutopilotStatus,
    AutopilotDevices {
  ...
  /**
   * Should be called if the mission is finished. Typically, it is called if the
   * flight plan has no more block to execute.
   */

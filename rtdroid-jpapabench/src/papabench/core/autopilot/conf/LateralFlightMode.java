 ...
 * @see Navigator
 * 
 * @author Michal Malohlava TODO put here description for each mode TODO this
 *         should be generated according to airplane configuration
 */
public enum LateralFlightMode {
  MANUAL, ROLL_RATE, ROLL, COURSE, NB
}

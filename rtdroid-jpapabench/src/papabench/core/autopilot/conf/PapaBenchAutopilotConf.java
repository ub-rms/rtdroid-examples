...
/**
 * Configuration for Autopilot subsystem - declares timing properties for the
 * tasks.
 * 
 ...
 * 
 *         TODO this class should be automatically generated according to AADL
 *         design
 */
public class PapaBenchAutopilotConf {
   ...
   * 
   */
  public static interface AltitudeControlTaskConf extends
  ...
  public static interface ReportingTaskConf extends CommonTaskConfiguration {
    ...
    public static final int PERIOD_MS = 100; // TODO: check this in AADL there
                                             // is f=10Hz, in code f=20Hz
    public static final int RELEASE_MS = 0;
    public static final int SIZE = 0;
  }

 ...
 * wikipedia</a> or <a
 * href="http://www.princeton.edu/~stengel/MAE331Lectures.html">this page</a>.
 * 
...
public class Attitude {
   ...
   * 
   * The range is (-PI .. PI). Positive value means the nose of airplane is up
   * else down.
   * 
   * 
   * To roll the plane to the right or left, the ailerons are raised on one wing
   * and lowered on the other. The wing with the lowered aileron rises while the
   * wing with the raised aileron drops.
   * 
   */
  public float phi;
   ...
   * 
   * The range is (-PI .. PI). Value 0 means North, positive value represents
   * clockwise direction.
   * 
   ...
   * else down.
   * 
   * Pitch is to make a plane descend or climb. The pilot adjusts the elevators
   * on the tail to make a plane descend or climb. Lowering the elevators caused
   * the airplane's nose to drop, sending the plane into a down. Raising the

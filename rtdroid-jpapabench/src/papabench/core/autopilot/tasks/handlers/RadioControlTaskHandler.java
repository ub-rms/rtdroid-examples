...
public class RadioControlTaskHandler implements Runnable {
  ...
  public void run() {
    // /* FBW actually never send msg to autopilot, all of the received msg is
    // invalid. */
    ...
    //
    // Log.i("Radio control task", "msg=>" + msg.toString());
    //
    ...
    // &&
    // (autopilotMode == AutopilotMode.AUTO1 || autopilotMode ==
    ...
    // // TODO setup modes, currently we are interested in in automatic mode
    // AUTO2
    // }
    //
    // if (modeChanged) {
    ...
    // autopilotModule.setRoll(PPRZUtils.floatOfPPRZ(msg.radioCommands.getRoll(),
    // 0.0f, -0.6f));
    // autopilotModule.setPitch(PPRZUtils.floatOfPPRZ(msg.radioCommands.getPitch(),
    // 0.0f, 0.5f));
    // }
    //
    // if (autopilotMode == AutopilotMode.AUTO1 || autopilotMode ==
    // AutopilotMode.MANUAL) {

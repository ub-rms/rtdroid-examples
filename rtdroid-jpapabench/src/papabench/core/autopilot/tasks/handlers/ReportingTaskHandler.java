...
//    System.out.println("Report Task" + " autopilot ==> "
//        + service.getMsgContent(AutopilotService.MSG_CRITICAL, 4));
//    System.out.println("Report Task" + " fwb ==> "
//        + service.getMsgContent(AutopilotService.MSG_NON_CRITICAL, 2));
    // Log.i("report task", "counter==>" + counter);
    counter++;
  }
